...
const ApiKeyWarningBanner: React.FC = () => {
  return (
    <div className="bg-error-bg border-b-2 border-error-text text-error-text p-3 text-center text-sm font-medium">
      <strong>Action Required:</strong> The Emergent LLM API key is not configured. AI features are disabled. 
      To fix this, add your <code>REACT_APP_EMERGENT_LLM_KEY</code> as an{' '}
      <a 
