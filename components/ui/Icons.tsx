...
export const FirebaseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M4.331 11.399l1.626-9.824 12.18.23-2.31 13.911-3.69-3.691-7.806-.626zm7.747-8.33l-1.39 8.364 3.69 3.691 2.05-12.333-4.35-1.011-.001.289zm-1.89 10.37l-4.226.338.835 5.025 5.518-5.518-2.127.155z" />
    </svg>
);
...
export const PaletteIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125s.148-.836.438-1.125c.257-.29.437-.688.437-1.125s-.18-.835-.437-1.125c-.29-.289-.438-.652-.438-1.125s.148-.836.438-1.125c.257-.29.437-.688.437-1.125C13.648 2.746 12.926 2 12 2z"></path>
    </svg>
);
